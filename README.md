...
2. **Entrega 2:** Estimar e comparar custos de infraestrutura em nuvem AWS
...
- **Memória RAM:** 1 GiB
- **Rede:** Até 5 Gigabit
- **Armazenamento:** 50 GB SSD (gp3)
- **Tipo de preço:** On-Demand (100%)
- **Sistema Operacional:** Linux

### 📊 Comparativo de Custos AWS (On-Demand)

Valores obtidos via AWS Pricing Calculator em 17/03/2026:

| Região | Instância | vCPU | RAM | Armazenamento | Preço/mês |
|---|---|---|---|---|---|
| 🇧🇷 São Paulo (sa-east-1) | t3.micro | 2 | 1 GiB | 50 GB gp3 | **$19.86 USD** |
| 🇺🇸 Virgínia do Norte (us-east-1) | t3.micro | 2 | 1 GiB | 50 GB gp3 | **$11.59 USD** |

> A região de Virgínia do Norte é ~42% mais barata que São Paulo.

### 🏆 Escolha Recomendada: São Paulo (BR)

Apesar de a região da Virgínia do Norte ser mais barata, a escolha recomendada é **São Paulo (sa-east-1)** pelos seguintes motivos:
...
2. No Google Colab, vá em **Ambiente de execução > Executar tudo**
3. O dataset é carregado automaticamente do Google Drive
